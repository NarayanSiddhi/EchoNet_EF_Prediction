    ...
    def __getitem__(self, idx):
        ...
        for _ in range(10):
            ...
            if real_video is not None and (not self.fused or syn_video is not None):
                ...
                sex, age_group, bmi_group = indices_from_demo_vector(demo_np)
                ...
                bmi_group = torch.tensor(bmi_group, dtype=torch.long)

                if not self.fused:
                    return real_video, ef, sex, age_group, bmi_group, demo_vec

                return real_video, syn_video, ef, sex, age_group, bmi_group, demo_vec
